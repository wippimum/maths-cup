...
(function (root) {
  ...
  const SUBJECTS = [
    ...
    { id: 'bidmas', year: 6, topic: 2, name: 'Order of Operations (BIDMAS)', icon: '🧮', blurb: 'Topic 2\u2019s last objective, on its own tile. Which part of the sum comes first?', levels: [
    ...
    { id: 'volume', year: 6, topic: 17, name: '3D Shape & Volume', icon: '🧊', blurb: 'Name solids and their nets; faces, edges and vertices; volume of cuboids and prisms.', levels: [
