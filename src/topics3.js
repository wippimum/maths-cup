    ...
    return {
      ...
      steps: [
        pickStep({ key: 'hcf',
          ...
          why: `To simplify a fraction you divide the top and bottom by the SAME number. That makes an EQUIVALENT FRACTION — it looks different but is worth exactly the same, because you have cut the whole into fewer, bigger pieces. Using the HCF gets you to lowest terms in one go.`,
        ...
        buildStep({ key: 'write', prompt: `Write the simplified fraction (use the number and / cards).`,
          ...
          why: `The simplified fraction is the new top over the new bottom. ${n}/${d} and ${sn}/${sd} are equivalent fractions, and ${sn}/${sd} is in its lowest terms because ${sn} and ${sd} have no common factor left.`,
