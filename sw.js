...
const ASSETS = [
  ...
  './icon-180.png',
  './src/styles.css?v=32',
  './src/fraction.js?v=32',
  './src/format.js?v=32',
  './src/parser.js?v=32',
  './src/numbers.js?v=32',
  './src/explanations.js?v=32',
  './src/figures.js?v=32',
  './src/steps.js?v=32',
  './src/topics.js?v=32',
  './src/topics2.js?v=32',
  ...
  './src/coords.js?v=32',
  './src/history.js?v=32',
  './src/numeracy1.js?v=32',
  './src/algebra1.js?v=32',
  './src/curriculum1.js?v=32',
  './src/curriculum2.js?v=32',
  './src/harder.js?v=32',
  './src/harder2.js?v=32',
  './src/bidmas.js?v=32',
  './src/solving.js?v=32',
  './src/problems.js?v=32',
  './src/app.js?v=32'
];
